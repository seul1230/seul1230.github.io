---
layout: post
title:  "TIL | FinanceDataReader를 통한 여러 종목 수익률 비교"
description: <strong>[ 공부 & 정리 ]</strong><br/>FinanceDataReader로 여러 종목 수익률 plotly로 비교하기
...
<strong> 👩🏻‍💻 오늘코드 실시간 강의 _ 박조은 강사님 </strong>
...
#### 다음 포스트에서 만나요 🙌
뒷 내용은 [**TIL | FinanceDataReader를 통한 여러 종목 daily price 비교**](https://seul1230.github.io/blog/financedatareader-dailyprofit-compare/)에서 이어서 작성한다.
