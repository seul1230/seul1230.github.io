...
---
# 0928 데이터 분석 TIL (1) _ 네이버 금융 뉴스 웹스크래핑
...
- [🐾　뉴스 한 페이지를 수집하는 함수　🐾](#-----------------------)
- [🐾　 반복문을 사용해 10페이지까지 수집　🐾](#-------------10-----------)
  * [tqdm의 trange](#tqdm--trange)
  * [그럼 이제 10페이지까지 수집하는 코드를 보자.](#------10-----------------)
  * [10페이지까지 수집하는 함수를 만들어보자.](#10--------------------)
- [🐾　네이버 금융 개별종목 수집　🐾](#--------------------)
  * [1. url 얻어오기](#1-url-----)
  * [2. Requests 모듈 사용해 URL에 접근](#2-requests--------url----)
  * [3. response.status_code가 200 OK라면 정상 응답](#3-responsestatus-code--200-ok--------)
  * [4. response의 text 값 받아오기](#4-response--text-------)
  * [5. html text를 BeautifulSoup을 통해 html 해석](#5-html-text--beautifulsoup-----html---)
    + [💡 find_all과 select의 차이는 뭘까?](#---find-all--select---------)
  * [6. soup.select를 통해 원하는 태그에 접근](#6-soupselect---------------)
- [🐾　데이터 수집 시작　🐾](#---------------)
  * [페이지별 데이터 수집 함수 만들기](#------------------)
