...
-> 더 자세한 설명은 [위키피디아](https://ko.wikipedia.org/wiki/HTTP_%EC%83%81%ED%83%9C_%EC%BD%94%EB%93%9C)를 참고하자.
...
![get_pages_120_reset]() <br/><br/>

#### 파일로 저장하고 저장된 파일 확인하기
![final_df]() <br/><br/>

### 다음 포스트에서 만나요 🙌
뒷 내용은 [**1004 데이터 분석 TIL (2)**]()에서 이어서 작성한다.
