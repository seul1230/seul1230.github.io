---
layout: post
title:  "꿀팁 | 오픽(OPIc) AL 하루만에 독학 벼락치기 성공 팁 (유용한 표현, 스크립트)"
...
# 꿀팁 | 오픽(OPIc) AL 하루만에 독학 벼락치기 성공 팁 (유용한 표현, 스크립트)
...
오랜만입니다 ⌯ ! 근황을 공개하러 총총 와보았어요! - ̗̀ (⌯ˊᗜˋ⌯)   ̖́-

최근에 오픽 성적을 받았는데 가장 높은 AL을 받았습니다 후후. 뭐 그렇다고 이게 영어 회화를 잘한다~라고 말해주진 않지만 공대생 주인장은 만조쿠!

사실은 영어권 나라에서 거주해본 적도 없고, 영어도 그렇게 잘하는 편은 아닙니다. 근데 주변에서 AL 어떻게 땄냐 꿀팁을 알려달라고 해서 한 명씩 알려주다가 이참에 기록을 하자!하고 책상에 앉았습니다.
...
## 하루 만에 오픽 독학 벼락치기 성공하는 법

서론이 길었습니다. 많은 분들이 오픽을 준비할 때 유튜브 '오픽노잼'을 흔히 추천하시는데, 저는 이것도 보는 게 귀찮아서 꼼수를 부려보았어요.

나름 전략을 잘 짰다고 생각하는데요. Survey, 답변 구조, 곤란할 때 유용한 표현에 나누어서 설명드리겠습니다.
...
이건 유명해서 다들 아실 거라 생각합니다. Survey 문항을 통해서 오픽 질문이 출제되는데, 주제가 너무 많아지면 질문이 더욱 예측불가 해집니다. 나에 대한 정보는 <strong><mark>무직, 1인 가구</mark></strong>로 제한하고 추가 질문이 그렇게 많지 않을 것 같은 취미로 기록해서 질문이 나올 수 있는 범위를 제한합니다. 물론 진짜로 좋아하고 잘 알아서 영어로 표현도 잘할 수 있다면 그러셔도 됩니다! 저 같은 경우는 걷기, 조깅, 음악 감상, 콘서트 가기, 영화 보기 등등을 선택했습니다.
...
### 언제 어디서나 써먹기 좋은 스크립트 구조

> 💬 어떻게 공부할까

앞서 말씀드렸듯이 저에게 주어진 하루, 어떻게 공부할까 하면서 집에 있는 <i><10일 만에 끝내는 해커스 OPIc - Advanced 공략></i> 교재를 처음부터 읽기 시작했습니다. 약 300 페이지에 달하는 분량이지만, 위에서 했던 Survey를 중심으로 나올 것 같은 주제 + 돌발 질문 파트만 공략해서 예시 스크립트를 완독했습니다.
...
저는 말주변이 있는 편은 아닙니다. 그래서 영어 실력을 보여주고 싶어도 질문을 받고 말할 거리가 없어서 고민이었는데, 이러면 채점자도 들은 게 없으니 채점할 게 없겠죠? 그래서 큰 틀을 다음과 같이 잡았습니다.
...
자 이제 마지막입니다! 오픽은 중간에 일시정지 버튼이 없어요! 시간도 빠듯한데 머리가 하얗게 되면 안 되겠죠? 이런 순간까지도 유창한 척 넘겨야 해요!ㅋㅋ 

그럴 때를 위한 표현을 가져와봤습니다 *ˊᵕˋ

실제로 적용했을 때 바로 AL을 받은 걸 보면, 아래와 같이 표현이나 단어들이 겹치지 않고 단순하지 않을 때 높은 점수를 주는 것 같습니다.
